package com.uni.stuttgart.ipvs.androidgateway.settings;
...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    public static class BluetoothPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            bindPreferenceSummaryToValue(findPreference("pref_legacy"));
            bindPreferenceSummaryToValue(findPreference("pref_scan_period"));
        }
